...
```{r}
binary_networks_data = read_csv('../../../../../features/network/binary/features_with_classification.csv') %>% filter (!network %in% c('46.csv', '48.csv', '50.csv', '51.csv', '54.csv', '55.csv', '56.csv', '57.csv', '61.csv', '62.csv', '63.csv', '64.csv', '66.csv', '70.csv', '71.csv', '72.csv', '73.csv') )
weighted_networks_data = read_csv('../../../../../features/network/weighted/features_with_classification.csv') %>% filter (!network %in% c('106.csv', '107.csv', '156.csv', '157.csv', '158.csv', '159.csv'))
binarized_networks_data = read_csv('../../../../../features/network/binarized_weighted/features_with_classification.csv')  %>% filter (!network %in% c('106.csv', '107.csv', '156.csv', '157.csv', '158.csv', '159.csv'))
...
all_network_binary_glm_data_no_null %>% ggplot(aes(x=robustness.LL, y=extinction.slope.LL)) + geom_point()
