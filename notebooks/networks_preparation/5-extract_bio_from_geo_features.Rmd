...
```{r}
eco_data = as.data.frame(Ecoregion_Polygon)
eco_data = eco_data[!duplicated(eco_data$ECO_ID),]
eco_data = st_as_sf(eco_data)
sf::st_write(eco_data, 'G:/My Drive/PhD/PlantPollinatorNetworks/plant_pollinator_networks/data/metadata/network_level/ecoregions_data.shp')
```
